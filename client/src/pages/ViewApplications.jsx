...
const ViewApplications = () => {
    ...
    return applicants ? applicants.length === 0 ? (
        ...
        <div className='container mx-auto p-4'>
            <div>
                <table className='w-full max-w-4xl bg-white border-gray-200 max-sm:text-sm border rounded-full'>
                    <thead>
                        ...
                        {applicants.filter(item => item.jobId && item.userId).map((applicant, index) => (
                            <tr key={index} className='text-gray-700'>
                                ...
                                <td className='py-2 px-4 border-b'>
                                    <a className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2' href={applicant.userId.resume} target='_blank'>Resume
