    ...
    <div>
      ...
      <div className='container min-h-screen flex flex-col py-10 px-4 2xl:px-20 mx-auto '>
        <div className='bg-white p-6 rounded-lg w-full '>
          <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 bg-sky-50 border border-sky-400 rounded-xl mb-16'>
            <div className='flex flex-col md:flex-row items-center '>
              <img className='h-24 bg-white rounded-lg p-4 mr-4 max-md:mb-4 ' src={assets.company_icon} alt="" />
          ...
          <div className='flex flex-col lg:flex-row justify-between items-start'>
            ...
            <div className='w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-8 space-y-5'>
              ...
              {jobs.filter(job=> job._id !== JobData._id && job.companyId._id === JobData.companyId._id).filter(job => true).slice(0, 4).map(job=> <JobCard key={job._id} job={job} />)}
            </div>
          </div>
